  ...
  <body class="overflow-x-hidden">
    ...
    <main>
      <div class="flex justify-center mt-12 px-4">
        <div
          class="flex flex-col opacity-80 items-center gap-8 p-6 bg-[#EEEEEE] rounded-3xl max-w-2xl w-full">
      ...
      <div
        class="flex flex-col lg:flex-row justify-center gap-6 mt-12 px-4 lg:px-6">
        <div
      ...
      <div
        class="flex flex-col lg:flex-row justify-center gap-6 mt-12 px-4 lg:px-6 mb-12">
        <div
          class="flex flex-col justify-between opacity-80 items-center gap-6 p-6 lg:p-12 bg-[#EEEEEE] rounded-3xl w-full max-w-[40rem] min-h-[20rem]">
          <h1 class="montserrat text-xl lg:text-2xl font-bold text-center">
            Why Choose Us?
